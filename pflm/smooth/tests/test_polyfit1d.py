...
def test_polyfit1d_happy_case(dtype):
    ...
    assert_allclose(
        ...
        np.array(
            [
                -0.026638964783, 0.336983831767, 0.725923679570, 1.143210394558,
                1.591704222727, 2.074075166076, 2.591704222727, 3.143210394558,
                3.725923679570, 4.336983831767, 4.973361035217
            ],
            dtype=dtype
        ),
        rtol=1e-5,
...
def test_polyfit1d_big(dtype):
    ...
    assert_allclose(
        ...
        np.array(
            [
                .120222650606, 0.163744104849, 0.207198694246, 0.250579480300,
    ...
    assert_allclose(
        ...
        np.array(
            [
                0.110947314133, 0.156101200364, 0.201097958085, 0.245932441500,
                0.290595814726, 0.335075970960, 0.379357751493, 0.423423014262,
                0.467250579590, 0.510816066137, 0.554091619151, 0.597045523594,
                0.639641685033, 0.681838949698, 0.723590220021, 0.764841300849,
                0.805529380496, 0.845581003914, 0.884909322265, 0.923410286498,
                0.960957260858
            ],
            dtype=dtype
        ),
    ...
    assert_allclose(
        ...
        np.array(
            [
                0.081800971835, 0.084431585507, 0.088703128302, 0.094041896410,
                0.099946779745, 0.105961664339, 0.111657921503, 0.116622510671,
                0.120449320547, 0.122732391605, 0.123060180651, 0.121010293436,
                0.116144235712, 0.108001765250, 0.096094381909, 0.079897359176,
                0.058839458991, 0.032288993188, -0.000465987307, -0.040247286035,
                -0.088033283274
            ],
            dtype=dtype
        ),
