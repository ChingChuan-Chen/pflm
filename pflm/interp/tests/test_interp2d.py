...
def test_interp2d_pyx_happy_case(dtype):
    ...
    assert_allclose(interp_func(x, y, A, x_new, y_new, 0), expected_linear, rtol=1e-5, atol=1e-6)
    assert_allclose(interp_func(x, y, A, x_new, y_new, 1), expected_spline, rtol=1e-5, atol=1e-6)
