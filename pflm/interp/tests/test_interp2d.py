...
def test_interp2d_pyx_happy_case(dtype):
    A = np.array(
        [[13.0, 8.0, 5.0, 1.0], [-1.0, 2.0, 4.0, 6.0], [12.0, 7.0, 3.0, 2.0], [-5.0, -4.0, 1.0, 4.0], [8.0, 4.0, 2.0, -3.0]], dtype=dtype
    )
