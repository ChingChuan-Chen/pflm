...
def interp2d_f64(
  ...
  int method = 0
    ...
    cdef int64_t x_size = x.shape[0], y_size = y.shape[0], x_new_size = x_new.size, y_new_size = y_new.size
...
def interp2d_f32(
    ...
    cdef int64_t x_size = x.size, y_size = y.size, x_new_size = x_new.size, y_new_size = y_new.size
